...
This directory gathers deployment and operations guidance for ARKOS services.

## Contents
- `openwebui_setup.md` – step-by-step host preparation and Compose stack instructions for OpenWebUI.
