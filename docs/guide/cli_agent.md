...
5. The Mem0 embedder is configured to call `http://localhost:4444/v1`. If you do not run an embeddings service there, update `memory_module/memory.py` or expect long-term retrieval to fail.
