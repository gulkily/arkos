...
**Format**: Ultra-concise comparison document (≤1 page) in `docs/ai_plans/`
...
**Format**: Concise document (≤1 page) in `docs/ai_plans/`
...
**Format**: Numbered stages in `docs/ai_plans/` (≤1 page)
...
Each step MUST be a separate file in `docs/ai_plans/`:
